...
public class OptionValueConverterCollection : IOptionValueConverterCollection
{
    ...
    public void Add(KeyValuePair<Type, IArgumentConverter> item) => _list.Add(item.Key, item.Value);
    ...
    public void Add(Type key, IArgumentConverter value) => _list.Add(key, value);
