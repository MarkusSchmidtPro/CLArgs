...
public class ContextBuilder
{
        ...
        ErrorDetailList errors)
    {
        ...
        var contextPropertyResolver = _serviceProvider.GetRequiredService<ContextPropertyResolver>();
        ...
        [NotNull] ErrorDetailList errors)
    {
        ...
        foreach (PropertyInfo propInfo in contextType.GetProperties())
        {
            ...
            ContextProperty contextProperty = contextProperties.FirstOrDefault(opt => _settings.Equals(opt.OptionName, optionName));
