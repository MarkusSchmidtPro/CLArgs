...
public class ContextBuilder
{
                                    ...
                                    ErrorDetailList errors)
    {
        ...
        ContextPropertyResolver contextPropertyResolver = _serviceProvider.GetRequiredService<ContextPropertyResolver>();
        ...
        var targetPropertyInfos = context.GetType().GetProperties();
        // Find first property with a TargetAttribute 
        var targetsPropertyInfo = targetPropertyInfos.FirstOrDefault(pi => pi.GetFirst<TargetsAttribute>() != null);
    ...
    private object createContext([NotNull] Type contextType,
                                 [NotNull] ContextPropertyCollection contextProperties,
                                 [NotNull] ErrorDetailList errors)
    {
        ...
        foreach (var propInfo in contextType.GetProperties())
        {
            ...
            var contextProperty = contextProperties.FirstOrDefault(opt => _settings.Equals(opt.OptionName, optionName));
            ...
            else if (!_optionValueConverters.ContainsKey(propertyType))
            {
            ...
            else if (!string.IsNullOrWhiteSpace(optionDescriptor.AllowMultiple))
            {
                ...
                var collectionPropertyInfo = contextType.GetProperty(collectionPropertyName);
            ...
            if (contextProperty.ProvidedValues.Count > 1)
            {
                errors.AddError(propertyName,
            ...
            else
            {
                ...
                object propertyValue =
                    _optionValueConverters[propertyType]
                       .Convert(contextProperty.ProvidedValues[0], optionName, errors, propertyType);
